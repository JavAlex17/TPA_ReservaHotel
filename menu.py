...
class MenuDesplegable(QWidget):
    def __init__(self, parent=None):
        ...
        self.setGeometry(11, 75, 150, parent.height() - 80)  # Posicionar debajo de la appBar
        self.raise_()  # Asegurar que el menú está sobre todos los demás widgets
        ...
        for opcion in opciones:
            ...
            if opcion == "Restaurante":
                boton.clicked.connect(parent.mostrar_restaurante)
            elif opcion == "Excursiones":
                boton.clicked.connect(parent.mostrar_excursiones)
            elif opcion == "Áreas Recreativas":
                boton.clicked.connect(parent.mostrar_areas_recreativas)
            elif opcion == "Reservar":
                boton.clicked.connect(parent.mostrar_reservar)
            elif opcion == "Volver al Inicio":
                boton.clicked.connect(parent.volver_main)
