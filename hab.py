...
class VentanaHabitaciones(QDialog):
    def __init__(self):
        ...
        #Agregar una appBar y el boton de menu a la izquierda
        ...
        tituloHotel.setStyleSheet('color: #686961;')
        tituloHotel.setFont(QFont(font, 20))
        ...
        logo_appbar.setPixmap(pixmap_logo)
        logo_appbar.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        appbar_layout.addWidget(logo_appbar,0,2)
        ...
        self.tituloHab.setStyleSheet("color: #686961; font-style: italic")
        self.tituloHab.setFont(QFont(font, 27, QFont.Weight.Bold))
    ...
    def actualizar_info(self):
        nombre_habitacion = f"<div style='color: #686961; font-size: 16pt; margin-left: 20px; font-style: italic; line-height: 1.5;'>{self.ListaNombres[self.indice]} - {self.ListaPrecios[self.indice]}</div>"
